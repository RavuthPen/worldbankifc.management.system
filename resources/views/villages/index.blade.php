            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <a href="{{ url('/village/create') }}" class="btn btn-success btn-sm">Add New</a>
        ...
        <div class="card-body">
            ...
            <table id="myTable" class="table table-bordered">
                <thead class="table-light">
                    <tr>
                        <th scope="col">No</th>
                        <th scope="col">Village-KH</th>
                        <th scope="col">Village-EN</th>
                    ...
                    @foreach ($villages as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('/village/' . $item->id . '/edit') }}"
